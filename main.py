...
class MusicPlayer:
    ...
    def __init__(self, root):
        ...
        Button(buttonframe, text="PLAY", command=self.playsong, width=6, height=1, font=(
        ...
        Button(buttonframe, text="RESUME", command=self.unpausesong, width=10, height=1, font=(
            "times new roman", 16, "bold"), fg="navyblue", bg="gold").grid(row=0, column=2, padx=10, pady=5)
        # Inserting Stop Button
        Button(buttonframe, text="STOP", command=self.stopsong, width=6, height=1, font=(
